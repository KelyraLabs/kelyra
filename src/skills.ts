...
name: ${name}
version: 0.1.0
description: Project-specific operating rules for verified Kelyra runs.
priority: 70
...
## Purpose
Describe what this project or workflow needs Kelyra to understand before it edits files.
